 ...
 * @Date: 2020/7/29
 */
public class TuiliwSpiderProcessor implements PageProcessor {
    ...
    public void process(Page page) {
        ...
        for (String url : urlList) {
            ...
            if (!fileUrl.equals("")) {
                ...
                String name = page.getHtml().xpath("//h1[@class='news_title']/text()").toString();
    ...
    private String dirUrl(String url) {
        boolean dirFlag = Pattern.matches("^/[a-zA-Z0-9]+/$", url);
        if (dirFlag) {
            return "http://kgbook.com" + url + "index.html";
        } else {
            dirFlag = Pattern.matches("https://kgbook.com/.*/index[_0-9]+.html$", url);
            if (dirFlag) {
                return url;
            }
        }
