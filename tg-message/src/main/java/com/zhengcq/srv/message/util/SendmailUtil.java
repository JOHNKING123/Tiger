package com.zhengcq.srv.message.util;
...
public class SendmailUtil {
    ...
    //发件人邮箱
    private static String myEmailAccount = "1318692162@qq.com";
...
//        props.put("mail.smtp.ssl.socketFactory", sf);
        ...
        msg.setFrom(new InternetAddress(myEmailAccount,"test-zcq", "UTF-8"));
