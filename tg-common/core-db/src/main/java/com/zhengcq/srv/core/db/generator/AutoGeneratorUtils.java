package com.zhengcq.srv.core.db.generator;
...
public class AutoGeneratorUtils {
    ...
    final static String SUPER_ENTITY_CLASS = "com.zhengcq.core.db.base.BaseModel";
    final static String SUPER_MAPPER_CLASS = "com.zhengcq.core.db.base.BaseDao";
    final static String SUPER_SERVICE_CLASS = "com.zhengcq.core.db.base.BaseService";
    final static String SUPER_SERVICE_IMPL_CLASS = "com.zhengcq.core.db.base.BaseServiceImpl";
...
//        System.out.println( properties.getProperty("spring.datasource.url") );
        ...
        // 自定义实体，公共字段
        strategy.setSuperEntityColumns(new String[] { "id", "enable", "remark", "created_by", "created_time", "updated_by", "updated_time" });
        // 自定义 mapper 父类
